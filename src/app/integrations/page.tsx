...
export const metadata: Metadata = {
  ...
  description:
    "Connect Registrum to your stack. Code-first REST API with Python and Node.js starter kits. Zapier, Make, and Google Sheets Add-on coming soon.",
};
      ...
      <section className="px-6 pb-16 pt-20 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-[#7A8FAD]">
            ...
            common languages, no-code connectors coming soon.
          </p>
        </div>
      </section>
